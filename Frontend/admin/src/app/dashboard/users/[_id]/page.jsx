...
export default async function page({ params }) {
  ...
  const userData = await fetchData(path);
  if (userData.error) {
    return (
      <div className="flex items-center mx-auto">
        <h1 className=" text-white ">{userData.error}</h1>
      </div>
    );
  }
  return (
        ...
        <form className="max-w-md mx-auto">
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              name="craeted"
              id="craeted"
              defaultValue={new Date(userData.createdAt)
                .toISOString()
                .slice(0, 10)}
              className="block py-2.5 px-0 w-full  text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              name="craeted"
              id="updated"
              defaultValue={new Date(userData.updatedAt)
                .toISOString()
                .slice(0, 10)}
              className="block py-2.5 px-0 w-full  text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
